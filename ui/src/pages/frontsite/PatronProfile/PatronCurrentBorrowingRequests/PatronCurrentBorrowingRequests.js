...
import { BorrowingRequestListEntry } from './components/BorrowingRequestListEntry';
...
export default class PatronCurrentBorrowingRequests extends Component {
  constructor(props) {
    super(props);
    this.fetchPatronCurrentBorrowingRequests = this.props.fetchPatronCurrentBorrowingRequests;
  ...
  componentDidMount() {
    this.fetchPatronCurrentBorrowingRequests(
      this.patronPid,
        ...
        <Loader isLoading={isLoading} renderElement={this.renderLoader}>
          <Error error={error}>
            ...
            <PatronCancelModal
              ...
              headerContent={
                'Are you sure you want to cancel your borrowing request?'
              }
              documentTitle={_get(
